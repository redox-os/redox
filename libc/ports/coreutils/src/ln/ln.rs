...
use redox::fs;
use redox::io::{BufRead, BufReader, Result, stdin, Write};
#[cfg(unix)] use redox::os::unix::fs::symlink as symlink_file;
#[cfg(windows)] use redox::os::windows::fs::symlink_file;
