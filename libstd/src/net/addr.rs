...
/// An IPv4 socket address which is a (ip, port) combination.
#[derive(Copy)]
pub struct SocketAddrV4 { inner: (u32, u16) }

/// An IPv6 socket address.
#[derive(Copy)]
pub struct SocketAddrV6 { inner: ([u8; 16], u16, u32, u32) }
...
impl SocketAddrV4 {
    ...
    /// Returns the IP address associated with this socket address.
        ...
        unsafe {
            &*(&self.inner.0 as *const u32 as *const Ipv4Addr)
        }
    }

    /// Change the IP address associated with this socket address.
    pub fn set_ip(&mut self, new_ip: Ipv4Addr) { self.inner.0 = *new_ip.as_inner() }

    /// Returns the port number associated with this socket address.
        pub fn port(&self) -> u16 { ntoh(self.inner.1) }

    /// Change the port number associated with this socket address.
    pub fn set_port(&mut self, new_port: u16) { self.inner.1 = hton(new_port) }
}
...
impl SocketAddrV6 {
    ...
    /// components.
        pub fn new(ip: Ipv6Addr, port: u16, flowinfo: u32, scope_id: u32)
               -> SocketAddrV6 {
        SocketAddrV6 {
            inner: (*ip.as_inner(), hton(port), flowinfo, scope_id),
        }
    }
    ...
    /// Returns the IP address associated with this socket address.
        ...
        unsafe {
            &*(&self.inner.0 as *const [u8; 16] as *const Ipv6Addr)
        }
    }

    /// Change the IP address associated with this socket address.
    pub fn set_ip(&mut self, new_ip: Ipv6Addr) { self.inner.0 = *new_ip.as_inner() }
    ...
    /// corresponding to the `sin6_flowinfo` field in C.
        pub fn flowinfo(&self) -> u32 { self.inner.2 }

    /// Change the flow information associated with this socket address.
    pub fn set_flowinfo(&mut self, new_flowinfo: u32) {
        self.inner.2 = new_flowinfo;
    }

    /// Returns the scope ID associated with this address,
    /// corresponding to the `sin6_scope_id` field in C.
        pub fn scope_id(&self) -> u32 { self.inner.3 }

    /// Change the scope ID associated with this socket address.
    pub fn set_scope_id(&mut self, new_scope_id: u32) {
        self.inner.3 = new_scope_id;
    }
}

impl FromInner<(u32, u16)> for SocketAddrV4 {
    fn from_inner(addr: (u32, u16)) -> SocketAddrV4 {
        SocketAddrV4 { inner: addr }
    }
}

impl FromInner<([u8; 16], u16, u32, u32)> for SocketAddrV6 {
    fn from_inner(addr: ([u8; 16], u16, u32, u32)) -> SocketAddrV6 {
...
impl hash::Hash for SocketAddrV4 {
    fn hash<H: hash::Hasher>(&self, s: &mut H) {
        (self.inner.1, self.inner.0).hash(s)
    }
}
impl hash::Hash for SocketAddrV6 {
    fn hash<H: hash::Hasher>(&self, s: &mut H) {
        (self.inner.1, &self.inner.0,
         self.inner.2, self.inner.3).hash(s)
    }
}
