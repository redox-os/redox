...
impl Xhci {
    ...
    pub unsafe fn init(&mut self) {
        ...
        // dl();
        //
        // Program the Device Context Base Address Array Pointer with a pointer to the
        // Device Context Base Address Array
        // let device_context_base_address_array = alloc(max_slots as usize *
        // size_of::<u64>()) as *mut u64;
        ...
        // Control register with a pointer to the first Trb
        ...
        // let event_ring_segment_table = alloc(event_ring_segments * size_of::<Ste>())
        // as *mut Ste;
