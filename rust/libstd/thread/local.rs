    ...
    (static $name:ident: $t:ty = $init:expr) => (
        static $name: $crate::thread::LocalKey<$t> =
            __thread_local_inner!($t, $init,
                #[cfg_attr(all(any(target_os = "macos", target_os = "linux", target_os = "redox"),
...
#[cfg(all(any(target_os = "macos", target_os = "linux", target_os = "redox"),
          not(target_arch = "aarch64"),
          not(no_elf_tls)))]
#[doc(hidden)]
mod imp {
...
#[cfg(any(not(any(target_os = "macos", target_os = "linux", target_os = "redox")),
          target_arch = "aarch64",
          no_elf_tls))]
#[doc(hidden)]
mod imp {
