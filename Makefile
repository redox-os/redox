...
filesystem/example.bin: example.rlib liballoc.rlib libcollections.rlib libmopa.rlib
	$(LD) -m elf_i386 -o $@ -T src/program.ld $< liballoc.rlib libcollections.rlib libmopa.rlib
